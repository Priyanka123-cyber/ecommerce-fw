        ...
        <section>
          ...
          <div className='border p-5'>
            <Grid2 container spacing={7}>
              ...
              <Grid2 item xs={5}>
                <h1 className='text-xl font-semibold pb-20'>Product Ratings</h1>
                <div className='flex items-center space-x-3'>
                ...
                <Box className='mt-5 space-y-3'>
                  <Grid2 container  alignItems="center" gap={2}>
                    ...
                    <Grid2 item xs={7}>
                        <LinearProgress variant="determinate" color="success" value={40} sx={{bgcolor:"#d0d0d0", borderRadius:4, height:100}} />
                    </Grid2>
                  </Grid2>
                  <Grid2 container  alignItems="center" gap={2}>
                    <Grid2 item xs={2}>
